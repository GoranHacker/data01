...
author: "Unidad de Inteligencia / SECOS"
date: "`r Sys.Date()`"
output:
...
resumen_final <- read.csv("https://drive.google.com/uc?export=download&id=1msGn85oD0pTDbf9Pzyf3nURyK-xeRS9x")
resumen_final %>%
...
summary_table <- read.csv("https://drive.google.com/uc?export=download&id=12OX064jmk4HYEYWnyq_lVWoB3-tfDycd")
summary_table %>%
