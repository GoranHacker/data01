...
datos_clima <- read.csv("https://drive.google.com/uc?export=download&id=108uG-B2gH5sGlmTc3Gv68XiUMNW943GE")
...
if(nrow(datos_precios_ultima_fecha_precio) > 0) {
  ...
  precios_por_especie <- datos_precios_ultima_fecha_precio %>%
    ...
    summarize(
      ...
      .groups = 'drop'  # Agrega esta línea para evitar problemas al imprimir la tabla
    )
  ...
  # Presentar los resultados en forma de tabla, asegurando que los datos están ordenados por el factor ESPECIE
  precios_por_especie %>%
...
# Agrupar los datos por FECHA y calcular el precio promedio de la caja por día
...
# Asegurándonos de que las fechas estÃÂ©n en formato de fecha para que ggplot las maneje correctamente
